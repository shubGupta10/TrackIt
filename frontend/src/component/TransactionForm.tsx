...
import { CreateTransactionInput } from "../generated/graphql";

const TransactionForm = () => {
  const [createTransaction, { loading }] = useMutation<CreateTransactionInput>(CREATE_TRANSACTION);
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!transactionData.description || !transactionData.amount || !transactionData.paymentType || !transactionData.category || !transactionData.date) {
